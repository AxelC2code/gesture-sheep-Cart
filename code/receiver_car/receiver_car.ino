...
void loop() {
  ...
  // 2. Sistema Failsafe (Perro Guardian anti-choques)
  // Si pasan mas de 500 milisegundos sin recibir un paquete WiFi, forzamos un STOP
  if (millis() - ultimoTiempoDatos > 500) {
    gestoActual = 'S'; 
  }

  // 3. Ejecucion fluida en el bucle principal
  switch (gestoActual) {
